Since , i was not able you connect backend with the front end for the login and register for the user , i have used the browser storage for storing the user.
